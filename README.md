...
현재 1장 **퍼셉트론**, 2장 **선형 분리와 XOR**, 3장 **다층 퍼셉트론**, 4장 **합성곱과 필터**를 공개했습니다. 논문과 역사적 맥락, 수식, 실제 프로젝트 코드, 단계별 시각화, 확인 문제를 같은 흐름으로 구성했습니다. 웹 실험은 브라우저에서 가볍게 실행하고, 실제 PyTorch 실습은 노트북으로 이어집니다.
