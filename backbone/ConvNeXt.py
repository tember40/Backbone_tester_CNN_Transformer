...
class ConvNeXt(nn.Module):
    ...
    def __init__(self, in_chans=3, num_classes=10, 
        ...
        self.depths = depths
        self.downsample_layers = nn.ModuleList() # stem and 3 intermediate downsampling convs
        stem = nn.Sequential(
...
class LayerNorm(nn.Module):
    ...
    The latter is typically used in ConvNeXts. 
    Args:
        normalized_shape (int): input channels. 
...
# From PyTorch examples, for stochastic depth
