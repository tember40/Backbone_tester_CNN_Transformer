...
def se_resnet18(num_classes=10, **kwargs):
    model = SENet(BasicBlock, [2, 2, 2, 2], num_classes=num_classes, **kwargs)
    return model

def se_resnet34(num_classes=10, **kwargs):
    model = SENet(BasicBlock, [3, 4, 6, 3], num_classes=num_classes, **kwargs)
    return model

def se_resnet50(num_classes=10, **kwargs):
    model = SENet(Bottleneck, [3, 4, 6, 3], num_classes=num_classes, **kwargs)
    return model

def se_resnet101(num_classes=10, **kwargs):
    model = SENet(Bottleneck, [3, 4, 23, 3], num_classes=num_classes, **kwargs)
    return model

def se_resnet152(num_classes=10, **kwargs):
    model = SENet(Bottleneck, [3, 8, 36, 3], num_classes=num_classes, **kwargs)
    return model
